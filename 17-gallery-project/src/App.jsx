...
const App = () => {
  ...
  return (
    <div className='bg-black overflow-auto h-screen text-white p-4'>
      {/* <button
        onClick={getData}
        className='bg-green-500 active:scale-95 text-white px-5 py-2 mb-3 rounded '>
        Get Data
      </button> */}
      ...
      <div className='flex justify-center gap-6 items-center p-4 '>
        ...
        style={{opacity: index == 1 ? 0.5 : 1}}
         className='bg-amber-400 text-sm cursor-pointer active:scale-95 text-black rounded px-4 py-2 font-semibold' onClick={()=>{
          if(index>1){
            setIndex(index-1)
            setUserData([])
          }
